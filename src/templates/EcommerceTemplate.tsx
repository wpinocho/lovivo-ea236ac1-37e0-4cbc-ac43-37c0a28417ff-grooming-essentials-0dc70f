    ...
    <div className={`bg-primary text-primary-foreground py-12 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="mb-4">
              <h3 className="text-xl font-bold">Premium Men's Grooming</h3>
            </div>
            <p className="text-primary-foreground/80">
              Elevate your grooming routine with our premium, natural products designed for the modern man.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-primary-foreground/20 text-center text-primary-foreground/80">
          <p>&copy; 2024 Premium Men's Grooming. All rights reserved.</p>
        </div>
      </div>
    </div>
  )
